...
if __name__ == '__main__':
    ...
    while True:
        ...
        if t_end_while - t_begin_whole_thing > 32:
            file_name_obse_pos = 'dis_scene2_obse_err_pos.csv'
            file_name_PFPE_pos = 'dis_scene2_PFPE_err_pos.csv'
            file_name_PFPM_pos = 'dis_scene2_PFPM_err_pos.csv'
            file_name_obse_ang = 'dis_scene2_obse_err_ang.csv'
            file_name_PFPE_ang = 'dis_scene2_PFPE_err_ang.csv'
            file_name_PFPM_ang = 'dis_scene2_PFPM_err_ang.csv'
            # boss_err_pos_df.to_csv('error_file/'+str(file_time)+file_name_pos,index=0,header=0,mode='a')
            # boss_err_ang_df.to_csv('error_file/'+str(file_time)+file_name_ang,header=0,mode='a')
