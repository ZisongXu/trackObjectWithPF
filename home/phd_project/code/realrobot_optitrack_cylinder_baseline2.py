...
class PFMove():
    ...
    def motion_update_copy(self, pybullet_sim_env_copy, rob_cur_pos, rob_cur_ori, rob_old_pos, rob_old_ori):
        ...
        parO_T_parN = copy.deepcopy(robO_T_robN)
        for index, pybullet_env in enumerate(pybullet_sim_env_copy):
            ...
            sim_particle_old_pos = [old_par_x,
                                    old_par_y,
                                    old_par_z]
            '''
            ...
            sim_particle_old_angle = [old_par_ang_x,
                                      old_par_ang_y,
                                      old_par_ang_z]
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if distance_between_current_and_old > d_thresh_limitation:
            ...
            print("rob_cur_ori:",rob_cur_ori)
            print("data_old[1]:",data_old[1])
