...
if __name__ == '__main__':
    ...
    while True:
        ...
        if flag_write_csv_file > 99 and write_file_flag_obse == 0:
        ...
        if flag_write_csv_file > 99 and write_file_flag_PFPE == 0:
        ...
        if flag_write_csv_file > 99 and write_file_flag_PFPM == 0:
