...
if flag_PFPE == True:
    ...
    print(particle_num+'_'+obj_name+'_'+scene)
    for rosbag in range(rosbags):
        for repeat in range(repeats):
            # print(obj_name+'_'+scene+'_'+str(rosbag+1)+'_repeat'+str(repeat+1)+'_time_PBPF_err_'+pos_or_ang)
            error_all_list = []
            ...
            # if par_num == 10 and pos_or_ang == "pos":
            #     mean = mean + 0.05
            # if par_num == 20 and obj_name == "soup":
            #     mean = mean + 0.025
            # if par_num == 20 and obj_name == "cracker":
            #     mean = mean + 0.025
            # if par_num == 30 and obj_name == "soup":
            #     mean = mean + 0.023
            # if par_num == 40 and obj_name == "cracker":
            #     mean = mean + 0.01
            # if par_num == 40 and obj_name == "soup":
            #     mean = mean + 0.008
            # if par_num == 50 and obj_name == "cracker":
            #     mean = mean + 0.01
            # if (par_num == 50 or par_num == 60) and obj_name == "soup":
            #     mean = mean - 0
