...
if ang_and_pos == "ang":
    ...
    figure_ang = sns.lineplot(x="time", y="Rotational Error (rad)", data=dataset_ang, hue = 'alg', errorbar=('ci', 95), legend=True, linewidth = 0.5)
...
if ang_and_pos == "pos":
    ...
    dataset_pos.columns=["index","time","Positional Error (m)","Method","obj_scene","particle_num","ray_type"]
    figure_pos = sns.lineplot(x="time", y="Positional Error (m)", data=dataset_pos, hue = 'Method', errorbar=('ci', 95), legend=False, linewidth = 0.5)
