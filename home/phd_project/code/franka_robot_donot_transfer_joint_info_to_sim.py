...
real_franka_robot_start_pos = [0.0, 0.0, 0.0]
...
#load and set object
cylinder_real_object_start_pos = [0.5, -0.23, 0.1]
...
class InitialSimulationModel():
    ...
    def display_particle(self):
        for index, particle in enumerate(self.particle_cloud):
            cylinder_visualize_particle_pos = [particle.x, particle.y, 0.1]
    ...
    def initial_and_set_simulation_env(self,pos_of_robot):
        for index, particle in enumerate(self.particle_cloud):
            ...
            cylinder_fake_robot_start_pos = [0.0, 0.0, 0.0]
            ...
            cylinder_particle_no_visual_start_pos = [particle.x, particle.y, 0.1]
...
class PFMove():
    ...
    #new structure
    def real_robot_control(self,franka_robot_current_joint_values):
        self.executed_control = []
...
if __name__ == '__main__':
    ...
    while True:
        ...
        Flag = robot1.real_robot_control(ros_listener.current_joint_values)
        if Flag is False:
            break
        p.stepSimulation()
        time.sleep(1./240.)   
