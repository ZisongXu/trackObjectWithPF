...
class PFMove():
    ...
    def update_particle_filter_cheat(self, pybullet_sim_env, fake_robot_id, real_robot_joint_pos, observation, pw_T_object_ori):
        ...
        if self.u_flag >= 9:
            ...
            boss_error_df.to_csv('cheezitPF_opti_3_50.csv',index=0,header=0,mode='a')
        ...
        if self.u_flag >= 9:
            print("write error file")
            boss_bsln2_df.to_csv('cheezitPM_opti_3_50.csv',index=0,header=0,mode='a')  
    ...
    def observation_update(self, observation,pw_T_object_ori):
        ...
        if self.u_flag >= 9:
            ...
            boss_obser_df.to_csv('cheezitOPES_opti_3_50.csv',index=0,header=0,mode='a')  
