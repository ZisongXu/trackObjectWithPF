...
if __name__ == '__main__':
    ...
    while True:
        ...
        if t_end_while - t_begin > 39:
            ...
            boss_obse_err_pos_df.to_csv('error_file/02_scene4_obse_err_pos.csv',index=0,header=0,mode='a')
            boss_obse_err_ang_df.to_csv('error_file/02_scene4_obse_err_ang.csv',index=0,header=0,mode='a')
        ...
        # if flag_write_csv_file > 65 and write_file_flag_PFPE == 0:
            ...
            boss_PFPE_err_pos_df.to_csv('error_file/02_scene4_PFPE_err_pos.csv',index=0,header=0,mode='a')
            boss_PFPE_err_ang_df.to_csv('error_file/02_scene4_PFPE_err_ang.csv',index=0,header=0,mode='a')
        ...
        # if flag_write_csv_file > 65 and write_file_flag_PFPM == 0:
            ...
            boss_PFPM_err_pos_df.to_csv('error_file/02_scene4_PFPM_err_pos.csv',index=0,header=0,mode='a')
            boss_PFPM_err_ang_df.to_csv('error_file/02_scene4_PFPM_err_ang.csv',index=0,header=0,mode='a')
