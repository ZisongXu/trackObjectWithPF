...
class InitialRealworldModel():
    ...
    def initial_target_object(self,object_pos,object_orientation = [0,0,0,1]):
        ...
        real_object_id = p_visualisation.loadURDF(os.path.expanduser("~/phd_project/object/cylinder_object_small.urdf"),
                                                  object_pos,
                                                  object_orientation)
        p_visualisation.changeDynamics(real_object_id,-1,lateralFriction = 0.56)
...
class InitialSimulationModel():
    ...
    def initial_and_set_simulation_env(self,pos_of_robot):
        for index, particle in enumerate(self.particle_cloud):
            ...
            pybullet_simulation_env.changeDynamics(cylinder_particle_no_visual_id,-1,lateralFriction = 0.56)
...
class PFMove():
    ...
    #new structure
    def real_robot_control(self,observation,real_robot_joint_pos):   
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if distance_between_current_and_old > d_thresh_limitation:
            ...
            Flag = robot1.real_robot_control(observation,ros_listener.current_joint_values)
