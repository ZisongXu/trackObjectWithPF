...
class PFMove():
    ...
    def update_particle_filter_cheat(self, pybullet_sim_env, fake_robot_id, real_robot_joint_pos, observation, pw_T_object_ori):
        ...
        if self.u_flag >= 10:
            ...
            boss_error_df.to_csv('error_sum_0_3_50.csv',index=0,header=0,mode='a')
        ...
        if self.u_flag >= 10:
            print("write error file")
            boss_bsln2_df.to_csv('baselin2_error_sum_0_3_50.csv',index=0,header=0,mode='a')
    ...
    def observation_update(self, observation,pw_T_object_ori):
        ...
        if self.u_flag >= 10:
            ...
            boss_obser_df.to_csv('obser_sum_0_3_50.csv',index=0,header=0,mode='a')        
