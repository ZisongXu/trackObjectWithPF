...
def move_home():
    ...
    home_config = [-0.7913731907159477, 1.218461793009517, -0.21681531773952015, -1.2628496909002114, 0.8311032503506469, 1.004525441980177, 1.1173198215497862]
    
    home_config = [-2.1566438906484726, -0.5230701578802307, 2.7796764020738243, -1.904925367035179, 0.6725453823242994, 2.5110059466626904, 2.645402378272922]
...
def joystick_callback(data):
    ...
    if data.buttons[KEYMAP['start']]:
        ...
        # cp_multi_2_one()
        print("Stop! Pressing l2")
    elif data.buttons[KEYMAP['r2']]:
        # cp_one_2_multi()
        print("Stop! Pressing r2")
