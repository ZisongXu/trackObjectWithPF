...
if flag_pos == True:
    ...
    #         newdataset = pd.DataFrame(columns=['step','time','error','alg'],index=[], header=None)
    #         # timedf = dataset['time']
    ...
    if flag_PFPE == True:
        ...
        for rosbag in range(rosbags):
            for repeat in range(repeats):
                ...
                df_picked = datasetcopy.tail(data_num)
                ...
                newdataset.to_csv('last_value_'+pos_or_ang+'.csv',index=0,header=0,mode='a')
